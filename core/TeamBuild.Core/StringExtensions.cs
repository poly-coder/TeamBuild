...
public static partial class StringExtensions
{
    ...
    public static int FoldToASCII(this ReadOnlySpan<char> input, Span<char> output)
    {
        var outputPos = 0;
    ...
    /// <returns> length of output </returns>
    /// <remarks>
    /// From: https://github.com/apache/lucenenet/blob/master/src/Lucene.Net.Analysis.Common/Analysis/Miscellaneous/ASCIIFoldingFilter.cs#L138
    /// </remarks>
    ...
    {
        return ((ReadOnlySpan<char>)input.AsSpan(inputPos, length)).FoldToASCII(
            output.AsSpan(outputPos..)
        );
    }
    ...
    public static string FoldToASCII(this string input)
    {
        ...
        var length = input.AsSpan().FoldToASCII(output);
